...
halostatue/starlist (Gleam) is copyright 2026 Austin Ziegler and available under
the [Apache License, version 2.0][apache-license-20], except:

- The copies of the Apache License and the Developer Certificate of Origin in
  `licenses/`.

It is based in part on [simonecorsi/mawesome][mawesome].
